...
$GLOBALS['TCA']['tx_mpreferenzen_domain_model_kategorie'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_mpreferenzen_domain_model_kategorie']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_mpreferenzen_domain_model_kategorie.pid=###CURRENT_PID### AND tx_mpreferenzen_domain_model_kategorie.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:mp_referenzen/Resources/Private/Language/locallang_db.xlf:tx_mpreferenzen_domain_model_kategorie.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
